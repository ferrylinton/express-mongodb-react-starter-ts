				...
				<table>
					<thead>
						<tr>
							...
							<th>
								<div
									className={getColumnClass('createdAt')}
							...
							<th>
								<div
									className={getColumnClass('app')}
									onClick={() => handleColumnClick('app')}
								>
							...
							<th>
								<div
									className={getColumnClass('ip')}
									onClick={() => handleColumnClick('ip')}
								>
							...
							<th>
								<div
									className={getColumnClass('userAgent')}
									onClick={() => handleColumnClick('userAgent')}
								>
									<FormattedMessage id="userAgent" />
								</div>
							</th>
						</tr>
					</thead>
					<tbody>
						{result &&
							result.data.map((reqestInfo, index) => {
